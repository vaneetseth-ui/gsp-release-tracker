...
const ADD_COLUMNS_SQL = [
  ...
  'ALTER TABLE releases ADD COLUMN IF NOT EXISTS tracker_project_title TEXT',
  'ALTER TABLE releases ADD COLUMN IF NOT EXISTS product_readiness_dri TEXT',
  'ALTER TABLE releases ADD COLUMN IF NOT EXISTS product_readiness_status TEXT',
  'ALTER TABLE releases ADD COLUMN IF NOT EXISTS product_readiness_start_date TEXT',
  'ALTER TABLE releases ADD COLUMN IF NOT EXISTS product_readiness_end_date TEXT',
  'ALTER TABLE releases ADD COLUMN IF NOT EXISTS product_readiness_comment TEXT',
  'ALTER TABLE releases ADD COLUMN IF NOT EXISTS gsp_launch_dri TEXT',
  'ALTER TABLE releases ADD COLUMN IF NOT EXISTS gsp_launch_status TEXT',
  'ALTER TABLE releases ADD COLUMN IF NOT EXISTS gsp_launch_start_date TEXT',
  'ALTER TABLE releases ADD COLUMN IF NOT EXISTS gsp_launch_end_date TEXT',
  'ALTER TABLE releases ADD COLUMN IF NOT EXISTS gsp_launch_comment TEXT',
  'ALTER TABLE releases ADD COLUMN IF NOT EXISTS tracker_details_json TEXT',
...
function rowToRelease(row) {
  return {
    ...
    tracker_project_title: row.tracker_project_title ?? null,
    product_readiness_dri: row.product_readiness_dri ?? null,
    product_readiness_status: row.product_readiness_status ?? null,
    product_readiness_start_date: row.product_readiness_start_date ?? null,
    product_readiness_end_date: row.product_readiness_end_date ?? null,
    product_readiness_comment: row.product_readiness_comment ?? null,
    gsp_launch_dri: row.gsp_launch_dri ?? null,
    gsp_launch_status: row.gsp_launch_status ?? null,
    gsp_launch_start_date: row.gsp_launch_start_date ?? null,
    gsp_launch_end_date: row.gsp_launch_end_date ?? null,
    gsp_launch_comment: row.gsp_launch_comment ?? null,
    tracker_details_json: row.tracker_details_json ?? null,
...
function releaseToInsertRow(r) {
  return [
    ...
    r.tracker_project_title ?? null,
    r.product_readiness_dri ?? null,
    r.product_readiness_status ?? null,
    r.product_readiness_start_date ?? null,
    r.product_readiness_end_date ?? null,
    r.product_readiness_comment ?? null,
    r.gsp_launch_dri ?? null,
    r.gsp_launch_status ?? null,
    r.gsp_launch_start_date ?? null,
    r.gsp_launch_end_date ?? null,
    r.gsp_launch_comment ?? null,
    r.tracker_details_json ?? null,
  ...
  try {
    ...
    const insertRel = `
      INSERT INTO releases (
        ...
        tracker_project_title, product_readiness_dri, product_readiness_status,
        product_readiness_start_date, product_readiness_end_date, product_readiness_comment,
        gsp_launch_dri, gsp_launch_status, gsp_launch_start_date, gsp_launch_end_date,
        gsp_launch_comment, tracker_details_json,
